...
def text_to_ask(text, sample_rate=44100, freq=1000, duration_per_bit=0.5):
    """
...
def write_ask_to_wav(text, filename="music.wav", sample_rate=44100, freq=1000, duration_per_bit=0.5):
    """
...
if __name__ == "__main__":
    ...
    write_ask_to_wav(text, "music.wav")
